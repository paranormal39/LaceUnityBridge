import * as __compactRuntime_ns from '@midnight-ntwrk/compact-runtime';
// esbuild may wrap CJS-like modules in .default when bundled
const __compactRuntime = (__compactRuntime_ns.default && __compactRuntime_ns.default.CompactTypeUnsignedInteger) ? __compactRuntime_ns.default : __compactRuntime_ns;
if (typeof __compactRuntime.checkRuntimeVersion === 'function') {
